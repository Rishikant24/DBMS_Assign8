...
if($fnameErr==1 && $lnameErr==1 && $emailErr==1 && $passErr==1 && $cpassErr==1)
{
   ...
   // here you can write Sql Query to insert user data into database table
        ...
        if(mysqli_query($conn, $sql)){
            $_SESSION['ffname'] = $firstName;
            $_SESSION['flname'] = $lastName;
        ...
        echo '<script type="text/javascript">
            ...
            window.onload = function () { alert("Updation Succesful"); }
    ...
    echo "ERORR UPDATING !!! PLEASE TRY AGAIN";
    echo "<br>";
    if($fnameErr!=1)
    {
        echo $fnameErr;
...
<button class="button-3" role="button">DashBoard</button>
</a>
<br>
<br>
